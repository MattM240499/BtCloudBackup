...
public class DocumentCheckpointStore 
{
    private readonly string _checkpointFilePath;

    public DocumentCheckpointStore(BackupOptions backupOptions, ILogger<DocumentCheckpointStore> logger) 
    {
        _checkpointFilePath = Path.Combine(backupOptions.BackupDirectory, "documentCheckpoint.json");
